...
class ResConfigSettings(models.TransientModel):
    ...
    def _get_product_average_consumption_order_dates(self):
        product_average_consumption_order_dates = self.env["ir.model.fields"].search(
            [
                ...
                ("name", "in", ["create_date", "write_date"]),
            ]
        )
        return [
            ...
            for field in sorted(
                ...
                key=lambda f: f.field_description,
            )
        ]
    ...
    def get_values(self):
        ...
        order_days = ir_config_sudo.get_param("product_average_consumption_order_dates")
        res.update(
            product_average_consumption_order_dates=(order_days),
        )
        return res
    ...
    def set_values(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "product_average_consumption_order_dates",
            self.product_average_consumption_order_dates,
        )
